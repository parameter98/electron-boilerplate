...
export const Route = createFileRoute("/gamedev-log")({
    component: GamedevLog,
});

export default function GamedevLog() {
            ...
            <div className="w-full h-full flex flex-col overflow-hidden bg-white dark:bg-gray-900">
                ...
                {isLoading && (
                    <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-white dark:bg-gray-900">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 font-medium">개발 일지 로딩 중...</p>
                    </div>
                )}

                <iframe
                    ref={iframeRef}
                    src="gamedevlog.html" // public 폴더의 파일 경로
                    title="Game Dev Log"
